...
def demonstrate_comprehensive_report_generation():
    ...
    print("-" * 40)
    print(
        physics_analysis[:400] + "..."
        if len(physics_analysis) > 400
        else physics_analysis
    )

    # Method comparison
    method_comparison = report_generator._generate_method_comparison_analysis(
        experimental_results
    )
    print("\n📊 Method Comparison Preview:")
    print("-" * 40)
    print(
        method_comparison[:350] + "..."
        if len(method_comparison) > 350
        else method_comparison
    )

    # Statistical analysis
    statistical_analysis = report_generator._generate_statistical_analysis(
        experimental_results
    )
    print("\n📈 Statistical Analysis Preview:")
    print("-" * 40)
    print(
        statistical_analysis[:300] + "..."
        if len(statistical_analysis) > 300
