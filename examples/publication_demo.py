...
from ml_research_pipeline.papers import PaperPlotGenerator, LaTeXTableGenerator, ReportGenerator
...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        table_generator.save_table_to_file(
            method_table, 
            output_dir / 'method_comparison_table.tex'
        )
        ...
        table_generator.save_table_to_file(
            ...
            output_dir / 'hyperparameters_table.tex'
        )
        ...
        table_generator.save_table_to_file(
            summary_table,
            output_dir / 'statistical_summary_table.tex'
        )
        ...
        print(executive_summary[:200] + "..." if len(executive_summary) > 200 else executive_summary)
        
        print("\nMethod Ranking (by accuracy):")
        ranking = report_generator._generate_method_ranking(experimental_results, 'accuracy')
