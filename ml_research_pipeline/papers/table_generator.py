...
class LaTeXTableGenerator:
    ...
    def create_method_comparison_table(self,
                                     ...
                                     label: str = "tab:method_comparison") -> str:
        """
        ...
        for method in methods:
            for metric in metrics:
                if f"{metric}_mean" not in results[method]:
                    raise KeyError(f"Missing metric '{metric}_mean' for method '{method}'")
                if f"{metric}_std" not in results[method]:
                    raise KeyError(f"Missing metric '{metric}_std' for method '{method}'")
    ...
    def create_statistical_summary_table(self,
                                       ...
                                       label: str = "tab:statistical_summary") -> str:
        """
    ...
    def create_hyperparameter_table(self,
                                  hyperparameters: Dict[str, Dict[str, Any]],
                                  caption: str = "Hyperparameter settings",
                                  label: str = "tab:hyperparameters") -> str:
        """
    ...
    def create_correlation_matrix_table(self,
                                      correlation_matrix: np.ndarray,
                                      variable_names: List[str],
                                      caption: str = "Correlation matrix",
                                      label: str = "tab:correlation_matrix") -> str:
        """
    ...
    def _format_hyperparameter_value(self, value: Any) -> str:
        ...
        if isinstance(value, bool):
            ...
            formatted_items = [self._format_hyperparameter_value(item) for item in value]
    ...
    def create_multi_table_document(self,
                                  tables: Dict[str, str],
                                  title: str = "Research Results Tables",
                                  author: str = "Generated by LaTeXTableGenerator") -> str:
        """
