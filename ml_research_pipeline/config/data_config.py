...
class DataConfig(BaseConfig):
    ...
    task_types: List[str] = field(default_factory=lambda: [
        "linear_viscosity", "bilinear_viscosity", "exponential_viscosity",
        "temperature_dependent", "non_newtonian"
    ])
...
class TaskConfig(BaseConfig):
    ...
    # Boundary conditions
    boundary_conditions: Dict[str, Dict[str, Any]] = field(default_factory=lambda: {
    ...
    # Initial conditions
    initial_conditions: Dict[str, Any] = field(default_factory=lambda: {
        "velocity": [0.0, 0.0],
        "pressure": 0.0
    })
...
class ViscosityConfig(BaseConfig):
    ...
    arrhenius_params: Dict[str, float] = field(default_factory=lambda: {
...
class GeometryConfig(BaseConfig):
    ...
    boundary_markers: Dict[str, int] = field(default_factory=lambda: {
        "inlet": 1,
        "outlet": 2, 
        "walls": 3,
        "cylinder": 4
